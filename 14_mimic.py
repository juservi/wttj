...
Dica Counter collections
Default Dict collections
É possível fazer sem nenhum if
...
def prepare_list(text):
    list_words = open_file(text)
    new_list = ['']
